  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          heading: "By consenting to these forms, I understand the following:",
          level: 3,
          body: [
        ...
        {
          heading: "Client Consent to the Use of Tele-health",
          level: 2,
          body: [],
        },
        {
        ...
        {
          heading: "What this is all about:",
          level: 3,
          body: [
        ...
        {
          heading: "We have adopted the following policies:",
          level: 3,
          body: [
        ...
        },
        {
          ...
          level: 3,
          body: [
            "I understand and accept the terms in order to render services that a credit card may be kept on file and that any remaining balances for services rendered shall be paid in full. I authorize MEDVi, LLC to submit on my behalf and the release of any medical records or other information necessary to process my consultation order. Fee schedules and receipts for all professional services are available upon request.",
            "I authorize MEDVi, LLC to make invoice changes and debit my account for orders placed, goods received, and/or services rendered not fully covered by third party vouchers or credits.",
            "I authorize MEDVi, LLC to charge my credit card account upon any unpaid balances due.",
        ...
        },
        {
          ...
          level: 3,
          body: [
            "All prescription medications are dispensed according to state and federal law with the approval of the pharmacist in charge and in compliance with all laws applicable from the relevant Medical Boards and State Boards of Pharmacy. The customer requesting shipping disclaims and agrees to hold harmless MEDVi, LLC for any delays or errors during the shipping process. Medication is considered dispensed and the order completed when it is signed out for shipping, not when it arrives via delivery.",
            "My continued use of the services constitutes my understanding and acceptance of the above terms and I give permission for MEDVi, LLC to ship medication to me at the address provided in my intake form or any other address given by me to the company and agree to all of the conditions listed above.",
          ],
        },
      ]}
    />
