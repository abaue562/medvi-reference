      ...
      sections={[
        {
          body: [
            ...
            "This Privacy Policy (the "Privacy Policy") describes how MEDVi, LLC collects and uses Personal Data about you through the use of our Website, and through email, text, and other electronic communications between you and MEDVi. The terms "we", "us", "our" and "MEDVi" refer to MEDVi, LLC, a Delaware corporation located at 131 Continental Dr, Ste 305, Newark, DE 19713.",
            "MEDVi respects your privacy, and we are committed to protecting it through our compliance with this policy. This Privacy Policy describes the types of information we and our affiliates, including certain affiliated professional entities (collectively, "MEDVi", "we", "our", or "us") may collect from you or that you may provide when you use MEDVi through our website ("website" or the "Platform").",
            ...
            "MEDVi is committed to protecting your privacy. We provide this Privacy Policy to explain the type of information we collect and to inform you of the specific practices and guidelines that protect the security and confidentiality of personal information.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            "Health-related information, such as clinical history and condition, and any other information exchanged in emails, texts, chats or calls between you and MEDVi.",
        ...
        {
          heading: "Information About You and Your Health Care Treatment and Payment",
          level: 3,
          body: [
            "The information we collect on or through our Platform may include:",
            "Information that we collect when you browse our website. Even without creating an account, we still may collect from you some of the information described in this Section II.",
        ...
        },
        {
          ...
          body: [
            ...
            "The information we collect automatically includes statistical data and may also include Personal Information. We may also maintain it or associate it with Personal Information you provide to us or that we collect in other ways or receive from third parties. It helps us to improve our Platform and to deliver a better and more personalized service, including by enabling us to: Estimate how individuals access and use our Platform; Store information about your preferences; Speed up your searches; Recognize you when you return to our Platform.",
            "The Platform may utilize "cookies" to improve the functionality of the Platform. Cookies are text files that are sent by servers to web browsers and stored on your computer. They tell us which parts of the Platform you've visited so MEDVi can alert you to software compatibility issues and save your preferences for future visits to the Platform. Some cookies and other technologies may serve to recall Personal Data previously provided by a user.",
            "We use information collected from cookies and other technologies to improve your user experience and the overall quality of our services. We use cookies to help us identify and track visitors, their usage of the Platform, and their access preferences. We may use your Personal Data to see which web pages you visit at our websites, which website you visited before coming to our website, and where you go after you leave our website. We can then develop statistics that help us understand how our visitors use our websites and how to improve them. Visitors who do not wish to have cookies placed on their computers should set their browsers to refuse cookies before using the Platform; provided, however, that MEDVi disclaims, and you hereby waive, any claim or liability that may arise due to your partial or incomplete access to the content of any of the Platform as a result thereof. Visitors also can utilize the Global Privacy Control ("GPC") add-on or browser preference, which signals that you do not want personal information collected by websites you visit. Our Sites are designed to respond to GPC signals.",
            "For more information about how MEDVi utilizes cookies, you can visit our Cookie Policy.",
          ],
        },
        {
          ...
          level: 3,
          body: [
            "We use Intuit's Quickbooks and/or Stripe as our payment processor. In order to allow these services to function properly, a cookie is stored on your browser, which assists in detecting and preventing fraud. These are considered session cookies and typically only remain on your browser for 24 hours. For more information, please visit their respective privacy policies at https://quickbooks.intuit.com/hk/privacy/; https://stripe.com/au/privacy.",
        ...
        },
        {
          ...
          body: [
            ...
            "To measure or understand the effectiveness of communications (including advertising) that we send to you and others, and to deliver relevant communications to you and to provide you with communications from MEDVi, surveys, newsletters, and other information.",
        ...
        {
          heading: "IV. Disclosure of Your Information",
          level: 2,
          body: [
            ...
            "To MEDVi and its affiliated professional entities' employees, or other third-parties who provide services to MEDVi or an affiliated professional entity.",
            ...
            "If we are under a duty to disclose or share your Personal Information to comply with any legal obligation, or in order to enforce or apply our Terms of Service and other agreements; or to protect the rights, property, or safety of MEDVi, our customers, or others. This may include exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.",
        ...
        {
          heading: "V. Options About How We Use And Disclose Your Information",
          level: 2,
          body: [
        ...
        {
          heading: "VII. Third-Party Platforms",
          level: 2,
          body: [
            "Our Platform may contain links or references to other websites outside of our control. Please be aware that this Privacy Policy does not apply to third-party websites. MEDVi encourages you to read the privacy statements and terms of service of linked or referenced websites you enter. These third-party websites may send their own cookies and other tracking devices to you, log your IP address, and otherwise collect data or solicit Personal Information.",
            "MEDVi DOES NOT CONTROL AND IS NOT RESPONSIBLE FOR WHAT THIRD PARTIES DO IN CONNECTION WITH THEIR WEBSITES, OR HOW THEY HANDLE YOUR PERSONAL INFORMATION. PLEASE EXERCISE CAUTION AND CONSULT THE PRIVACY POLICIES POSTED ON EACH THIRD-PARTY WEBSITE FOR FURTHER INFORMATION.",
          ],
        },
        {
          heading: "VIII. No Services To Persons Under The Age of 18",
          level: 2,
          body: [
            "MEDVi does not knowingly provide services to minors under 18.",
          ],
        },
        {
          heading: "IX. California Resident Privacy Rights",
          level: 2,
          body: [
        ...
        {
          heading: "For your Personal Information covered by the CCPA, your rights are described below.",
          level: 3,
          body: [
            "I. Personal Information Disclosures — In the last twelve (12) months, we have collected the following categories of Personal Information about you: Identifiers (e.g., name, mailing address, email address, and telephone number, as well as unique identifiers such as your IP address, cookies or similar data); Characteristics of protected classifications under California or Federal law (e.g., your gender or age); Internet or Other Electronic Network Activity Information (e.g., browsing history, activity, and service pages visited to help you get started, and information regarding your interactions with our Platform); Geolocation Data; Professional or employment-related information (e.g., your occupation); Audio, electronic or similar information when you contact our customer care center by phone; Inferences drawn from the information identified above.",
            "We collect this Personal Information directly from you when you provide it to us; automatically as you navigate through the Platform; or from third-party sources to help us determine whether a MEDVi product or service is right for you and to send promotional emails and/or text messages to customers and prospective customers.",
            "II. Categories of Personal Information — Categories of Third-Parties: Identifiers (e.g., such as your email address, IP address, account login information, cookies or similar data) — Service providers who provide professional or technical support functions; professional service organizations; analytics providers for our Platform. Internet or other similar network activity (e.g., browsing history, activity, and service pages visited to help you get started, search history, and information regarding your interactions with our Platform). Geolocation data.",
            "III. California Resident Privacy Rights — If you are a California resident, you have the following rights:",
        ...
        {
          heading: "XI. Contact Information",
          level: 2,
          body: [
