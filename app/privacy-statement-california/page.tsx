...
export default function PrivacyStatementCalifornia() {
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          heading: "Category A. Identifiers.",
          level: 3,
          body: [
        ...
        {
          heading: "Category B. Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)).",
          level: 3,
          body: [
        ...
        {
          heading: "Category C. Characteristics of protected classifications under California or federal law.",
          level: 3,
          body: [
            "Examples: Gender, Age, Citizenship Status, Disability, Marital Status",
            "Collected: Yes",
          ],
        },
        {
          heading: "Category D. Commercial information.",
          level: 3,
          body: [
            "Examples: FEIN, HH Premium, Home Value, Income Line of Business, Lines of Insurance Purchased, Net worth, Payment Information, Pension Dollar Amounts, Personal Property Records, Policy Count by Product, Policy Number, Property Address, Property Ownership, Vehicle Information",
            "Collected: Yes",
          ],
        },
        {
          heading: "Category E. Biometric information.",
          level: 3,
          body: [
        ...
        {
          heading: "Category F. Internet or other similar network activity.",
          level: 3,
          body: [
            "Examples: Advertising Recall, App Usage, Browser Type, Chat Transcripts, Cookies, Device, Email Transcripts, HM Drive Usage, Interaction with Website, IP Address, Location, My Account Activity Log, Web Message Transcripts, Web Site Usage",
            "Collected: Yes",
          ],
        },
        {
          heading: "Category G. Geolocation data.",
          level: 3,
          body: [
            "Examples: Direction of Travel, Latitude, Longitude, Rate of Acceleration, Rate of Speed, Survey Location",
            "Collected: No.",
          ],
        },
        {
          heading: "Category H. Sensory data.",
          level: 3,
          body: [
            "Examples: Audio Recordings of Historic Transfer Requests, Audio Recordings of Medical Interviews, Audio Recordings of Phone Calls",
            "Collected: Yes",
          ],
        },
        {
          heading: "Category I. Professional or employment-related information.",
          level: 3,
          body: [
            "Examples: Annual Salary, Bank Account Information, Educator vs Non Educator, Employer Name, Employment Location, Employment Status, Hire Date, Household Income, Job Title, Length of Service, Number of years working in Education, Occupation, Occupation Code, Percentage of Increase, Resume, Tenure, Termination Date, Transfer Date, Work History",
            "Collected: Yes",
          ],
        },
        {
          heading: "Category J. Non-public education information (per the Family Educational Rights and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)).",
          level: 3,
          body: [
        ...
        {
          heading: "Category K. Inferences drawn from other personal information.",
          level: 3,
          body: [
            "Examples: Paperless Preferences, Login Email, Security Preferences, Address Preferences, Consumer Preferences, Attitudes, Psychographic data, Survey Comments, Investment Strategy, E-delivery Preferences",
            "Collected: Yes",
          ],
        },
        {
        ...
        {
          heading: "Sensitive personal information means Information that reveals:",
          level: 2,
          body: [
            ...
            "Contents of your mail, email, and text messages unless MEDVi is the intended recipient of your communication.",
            "Your genetic data.",
          ],
        },
        {
          heading: "Unless the information is publicly available, sensitive personal information also includes:",
          level: 3,
          body: [
        ...
        },
        {
          ...
          body: [
            ...
            "In the preceding twelve (12) months, we have disclosed the following categories of personal information to third parties for a business purpose: None.",
        ...
        {
          heading: "Access to Specific Information and Data Portability Rights",
          level: 3,
          body: [
            "You have the right to request that we disclose certain information to you about our collection and use of your Personal Information collected on or after January 1, 2024. Once we receive and verify your request, we will disclose to you any of the following in accordance with your request:",
        ...
        {
          heading: "Opting Out of Use and Disclosure of Sensitive Personal Information",
          level: 3,
          body: [
        ...
        {
          heading: "Deletion Request Exceptions",
          level: 3,
          body: [
        ...
        {
          heading: "Exercising Access, Data Portability, and Deletion Rights",
          level: 2,
          body: [
            "To exercise the access, data portability, and deletion rights described above, please submit a verifiable consumer request to us by either:",
            "Calling us at (844) 357-3601.",
            "Visiting medvi.org",
            "Emailing help@medvi.org",
        ...
        {
          heading: "Response Timing and Format",
          level: 2,
          body: [
        ...
        {
          heading: "Changes to Our Privacy Notice",
          level: 2,
          body: [
