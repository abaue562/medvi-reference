      ...
      sections={[
        {
          ...
          level: 2,
          body: [
            "MEDVi is contemplated for specific non-emergency medical conditions and concerns. If you believe you are experiencing a medical emergency, please dial 911 or your local medical provider.",
            "This User Agreement (collectively with MEDVi's Privacy Policy) applies to your use of all sites (collectively, the \"Sites\") to which this User Agreement is linked, and the services, features, content or applications (together with the Sites, the \"Services\") offered by MEDVi and our affiliated brands and products. The terms "we", "us", "our" and "MEDVi" refer to MEDVi, LLC, a Delaware corporation located at 131 Continental Dr, Ste 305, Newark, DE 19713.",
            ...
            "These Terms of Use (the "Terms") describe your rights and responsibilities regarding the MEDVi website ("website" or the "Platform") owned and operated by MEDVi.",
            "In these Terms, "we", "our", "us", and "MEDVi" collectively refer to MEDVi and any products, subsidiaries, and affiliations. The terms "you" and "yours" refer to the person using the Platform. Use of the Platform is governed by these Terms and our Privacy Policy. By accessing or using the Platform, you acknowledge that you have read, understood, and agreed to be legally bound by and comply with these Terms and our Privacy Policy.",
            "Even though you may have arrived at the Platform through a website operated or controlled by a third party, including by an affiliate of MEDVi, you understand and agree that these Terms are entered into between you and MEDVi. You also understand and agree that the Platform and any services provided through these Terms, except the Healthcare Services described herein, are provided by MEDVi.",
            "You agree that when you use or enter the Platform, you affirmatively consent to conduct business electronically with MEDVi and engage in health-oriented activities with health professionals and professional entities affiliated with MEDVi, and such processes have the same force and effect as your written signature. You agree and consent to MEDVi and certain affiliated professional entities sending you disclosures, messages, notices, and other communications to your designated mobile phone and email account. If you do not agree with any of these Terms or our Privacy Policy, you may not use the Platform.",
        ...
        {
          heading: "III. Description of MEDVi",
          level: 2,
          body: [
            ...
            "Further, you consent to our delivery of Your Information to MEDVi affiliated and unaffiliated pharmacies, laboratories, and other diagnostic testing companies as part of coordinating desired fulfillment and payment for diagnostic testing, prescription medications, and medical devices recommended as part of the Healthcare Services.",
            "All medical providers who deliver Healthcare Services through the Platform are: (i) independent professionals contracted or employed with affiliated professional entities that coordinate with MEDVi and (ii) solely responsible for such Healthcare Services provided to you.",
            "MEDVi does not provide any Healthcare Services through the Platform and is not licensed to practice medicine. MEDVi does not control or interfere with the provision of Healthcare Services by the medical providers and affiliated professional entities, each of whom is independent and solely responsible for the Healthcare Services provided to you. You, therefore, understand and agree that MEDVi is not responsible for Healthcare Services, or your use of any Healthcare Services provided by a medical provider or affiliated professional entity, including any personal injury or property damage.",
            "By accepting this Agreement, you additionally understand and agree that MEDVi is not acting as a pharmacy, nor do we control or interfere with any such services. By accepting this Agreement, you understand and agree that you may be entering into a relationship with a pharmacy, pharmacist, and/or pharmacy group or other such relationship with any one or more such third-party entities.",
          ],
        },
        {
        ...
        },
        {
          ...
          level: 2,
          body: [
            "The Services are currently available to individuals located in certain states. To see the list of current states, please contact customer service at help@medvi.org.",
          ],
        },
        {
          ...
          level: 2,
          body: [
            "Although certain parts of the Platform are accessible by any individual, you are obligated to register with MEDVi in order to access the Services. The Services are available only to users who have registered with MEDVi and to other persons affiliated with MEDVi who have been granted accounts with usernames and passwords. The Platform may not be accessible at any time, for any period, or for any reason, and MEDVi will not be liable if, for any reason, all or any part of the Platform is unavailable at any time or for any period.",
            "Upon registration of an account, the Platform may contain forms or fields that allow you to enter, submit, or transmit to MEDVi user information or data ("User Data") on or through the Platform. You understand and agree that any User Data provided by you on or through the Platform may be used, copied, or displayed by MEDVi. MEDVi may create derivative works of any such data, and MEDVi may provide such data to our service providers, our successors and assigns, and medical providers and their affiliated professional entities, in performance of the Services.",
            "You grant MEDVi, our service providers, our successors and assigns, and medical providers and their affiliated professional entities, the fully transferable and sublicensable right and license to use, reproduce, modify, analyze, perform, display, distribute, and otherwise disclose to third-parties any User Data you submit on or through the Platform for the purposes of providing the Services to you; conducting research or analyses of such data; and designing, developing, implementing, modifying and/or improving new, current or future features, products and services of MEDVi using such data.",
          ],
        },
        {
          ...
          body: [
            ...
            "All Your Information provided through the Platform is accurate, complete, and correct, and you will accurately maintain and update any of Your Information that you have provided to MEDVi.",
            ...
            "You agree to immediately notify MEDVi of any unauthorized use of your username, password, or any other breach of security that you become aware of involving or relating to the Services by emailing MEDVi at help@medvi.org.",
            "You may be asked to provide additional information to MEDVi, its affiliated professional entities, or applicable medical provider(s) for the purpose of providing Healthcare Services or fulfilling a prescription. You may elect to withhold requested information; however, if you do so, you may not use the Platform or any other related services.",
            "You understand and agree that provision of Healthcare Services through the Platform depends on the completeness and accuracy of Your Information. MEDVi is unable to verify all of Your Information, therefore, MEDVi is not responsible for any consequences if Your Information is inaccurate or incomplete. If Your Information is inaccurate, incomplete, or not maintained; or MEDVi has reasonable grounds to suspect as much, MEDVi has the right to suspend or terminate your account and your use of the Services. In addition, MEDVi may take any and all actions it deems necessary or reasonable to maintain the security of the Platform, Services, and your Secure User account.",
          ],
        },
        {
          ...
          body: [
            ...
            "Use or access the Platform to create or develop competing products or services or for any other purpose that is detrimental to MEDVi or puts MEDVi at a commercial disadvantage.",
            ...
            "Bypass, breach, avoid, remove, deactivate, impair, descramble, or otherwise circumvent any security device, protection, or technological measure implemented by MEDVi or any of our service providers to protect our Platform.",
            ...
            "Copy, duplicate, download, store in a retrieval system, publish, transmit or otherwise reproduce, transfer, distribute, store, disseminate, aggregate, use as a component of or as the basis for a database or otherwise use in any form or by any means any data, text, reports, or other materials related to MEDVi or third-party content from the Platform; or",
        ...
        },
        {
          ...
          level: 2,
          body: [
            "Subject to your compliance with these Terms, MEDVi grants you a personal, limited, revocable, nonexclusive, and non-transferable license to view, download, access, and use the Platform and its content, solely for your personal and non-commercial use. No other right, title, or interest in or to the Platform is transferred to you, and all rights not expressly granted are reserved by MEDVi and its licensors. You are not permitted to reproduce, publish, transmit, distribute, display, modify, create derivative works from, sell or participate in any sale of, or exploit in any way, in whole or in part, any such content for commercial use.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            "By using the Services, you agree and acknowledge that MEDVi is a beneficiary of the Medical Consent and has the right to enforcement.",
          ],
        },
        {
          heading: "XII. Payment",
          level: 2,
          body: [
            "When you submit Your Information for Health Care Services, you agree to pay all fees due. By entering your payment information and submitting your request, you authorize us, our affiliates, or our third-party payment processors to charge the amount due. If you receive a medical consultation, medical consult fees are not subject to or eligible for a refund. We cannot accept returns of prescription products for reuse or resale, and all sales are final. If you believe we have made an error please message us through your MEDVi portal or email us.",
            "You understand and agree that you are responsible for all fees due to receive the Services, including any fees charged by medical providers and affiliated medical professional entities. Kindly be advised that the final charge to your credit card may fluctuate contingent upon the prescribed medication and the chosen pharmacy for order fulfillment. Should any variance arise in the charge, a dedicated member of our support team will expeditiously communicate the details to you. Please be informed that we gather essential payment data, encompassing your payment instrument particulars (such as credit card number) and associated security code, solely for the purpose of facilitating payment processing. It is imperative to note that all payment information is meticulously safeguarded within the secure infrastructure provided by Stripe. For a comprehensive understanding of data privacy practices, we encourage you to peruse the privacy notice available at: https://stripe.com/privacy.",
            "You understand that MEDVi-affiliated medical professional entities are not contracted healthcare providers with any health insurance plans (commercial, government, or otherwise, i.e., "out-of-network" providers), and therefore, you understand and agree that you are exclusively and solely responsible for paying all fees due to receive the Healthcare Services provided to you, including any fees charged by the medical providers and affiliated medical professional entities. Amounts collected by MEDVi will include fees charged by medical providers for Healthcare Services. In the event that your credit card expires or MEDVi, our affiliates, or our third-party payment processors are unable to process your payment, you may receive notice for you to provide an alternative payment method. MEDVi and/or the medical provider(s) have no obligation to provide any Healthcare Services unless and until full payment has been received and/or verified.",
            "You also understand and agree that, because MEDVi medical providers are not contracted with any health insurance plan to provide the Healthcare Services, including federal or state government health care programs, like Medicaid and Medicare, any prescription medication or laboratory service ordered by a MEDVi medical provider may also not be covered.",
          ],
        },
        {
          heading: "XIII. Privacy",
          level: 2,
          body: [
            "MEDVi understands the importance of confidentiality and privacy regarding Your Information. Please see our Privacy Policy for a description of how we may collect, use, and disclose Your Information in connection with the Platform.",
          ],
        },
        {
          heading: "XIV. Intellectual Property",
          level: 2,
          body: [
            "As between MEDVi and you, MEDVi is the sole and exclusive owner of all right, title, and interest in and to the Platform and its content, features, and functionality (including, without limitation, all information, software, text, displays, images, video, audio, selection, arrangement, and look and feel), and all intellectual property rights therein, and any suggestions, ideas, or other feedback provided by you. Any copy, modification, revision, enhancement, adaptation, translation, or derivative work of the Platform shall be owned solely and exclusively by MEDVi or its licensors, including all intellectual property rights therein. You have permission to use the Platform solely for your personal and non-commercial use on the condition that you comply with these Terms. No other right, title, or interest in or to the Platform is transferred to you, and all rights not expressly granted are reserved by us or our affiliates.",
            "Certain names, logos, and other materials displayed in and throughout the Platform may constitute trademarks, trade names, services marks, or logos ("Trademarks") of MEDVi or its affiliates. You are not authorized to use any such Trademarks without the express written permission of MEDVi or its affiliates. Ownership of all such Trademarks and the goodwill associated therewith remains with us or our affiliates.",
          ],
        },
        {
          heading: "XV. Third-Party Links and Websites",
          level: 2,
          body: [
        ...
        },
        {
          ...
          body: [
            ...
            "Subject to applicable law, MEDVi reserves the right to maintain, delete, or destroy all communications and materials posted or uploaded to the Platform pursuant to its internal record retention and/or content destruction policies. After any termination, MEDVi will have no further obligation to provide the Services, except to the extent we are obligated to provide you access to your health records or required to provide you with continuing care under our applicable legal, ethical, and professional obligations to you.",
          ],
        },
        {
          heading: "XXI. Governing Law; Dispute Resolution; Arbitration",
          level: 2,
          body: [
            "IN THE EVENT OF A DISPUTE, YOU AND MEDVI AGREE TO TRY TO RESOLVE IT INFORMALLY FIRST. IF WE CAN'T RESOLVE IT IN 60 DAYS, WE AGREE TO WAIVE THE RIGHT TO TRIAL BY JURY AND ARBITRATE THE CLAIM, INSTEAD OF GOING TO COURT. YOU MAY OPT-OUT OF ARBITRATION WITHIN 30 DAYS OF FIRST ACCEPTING THIS ARBITRATION CLAUSE, AS DESCRIBED BELOW.",
            "You agree to resolve disputes with MEDVi through binding arbitration, except as described in this Dispute Resolution section (the "Arbitration Clause"). The parties expressly waive the right to bring or participate in any kind of class, collective, or mass action, private attorney general action, or any other representative action. Similar disputes may, however, be grouped as a Mass Filing in arbitration.",
            "In agreeing to this arbitration provision, you and MEDVi agree to waive any constitutional and statutory rights to sue in court and have a trial in front of a judge or a jury. You and MEDVi are instead electing that all disputes will be resolved by arbitration under this Arbitration Clause, except as specified herein. Arbitration awards are subject to very limited judicial review. Discovery may be limited in arbitration, and procedures are more streamlined than in court.",
            ...
            "Covered Disputes. You and MEDVi agree that any dispute or claim between you and MEDVi arising out of or relating to this Agreement, User Data, the Platform or the Services (a "Dispute") will be resolved by binding arbitration, rather than in court. A Dispute includes any claim or dispute relating to the Services, access and use of the Services, your account, or any aspects of your relationship or transactions with MEDVi. A Dispute also includes any claims or disputes that arose from or involve facts that occurred before the effectiveness of this Agreement and claims that may arise after its termination. For clarity, nothing in this Arbitration Clause prevents either party from settling any Dispute(s) on a class-wide, batch-wide, or other multiparty basis.",
            "Exceptions to Arbitration. This Arbitration Clause does not require arbitration of the following types of claims brought by either you or MEDVi: Small claims court actions, if the requirements of the court are met and the claims are only on an individual basis; and Claims pertaining to intellectual property rights, including trademarks, trade dress, domain names, trade secrets, copyrights, and patents.",
            "Informal Dispute Resolution First. Like you, we want to resolve Disputes without resorting to arbitration. If you have a Dispute with us, before initiating arbitration, you agree to send an individualized request ("Pre-Arbitration Demand") to help@medvi.org so that we can work together to resolve the Dispute. If the Dispute is not resolved within sixty (60) calendar days of when either you or MEDVi submitted a Pre-Arbitration Demand, an arbitration can be brought. Informal dispute resolution is a condition precedent to commencing arbitration, but does not apply to claims falling under the exceptions to arbitration.",
            "Opt-Out. You may reject this Arbitration Clause and opt out of arbitration by sending an email to help@medvi.org within thirty (30) calendar days of first accepting these Terms. If you have an account, your opt-out notice must be sent from the email address associated with your account. No one may opt-out another person. Your notice to opt-out must include your first and last name, address, the email address associated with your account (if you have an account), and a clear statement that you decline this Arbitration Clause.",
            "Arbitration Procedure. If, after completing the informal dispute resolution process, you or MEDVi wish to initiate arbitration, the initiating party must serve the other party with a demand for arbitration. Any demand for arbitration by you will be sent to: MEDVi, LLC, 131 Continental Dr, Ste 305, Newark, DE 19713, help@medvi.org. MEDVi will send any arbitration demand to the email address associated with your account or to your counsel, if any. You and MEDVi agree that the Federal Arbitration Act ("FAA") governs this Arbitration Clause. If the FAA cannot apply, then the state laws governing arbitration procedures where you reside apply.",
            ...
            "Class Action Waiver. You and MEDVi agree that, except as specified under the Batch Process rules set forth below, you and MEDVi may bring claims against the other only on an individual basis and not on a class, collective, representative, or mass action basis. The parties agree to waive all rights to have any Dispute be brought, heard, administered, resolved, or arbitrated on a class, collective, representative, or mass action basis. Subject to this Arbitration Clause, the arbitrator may award declaratory or injunctive relief only in favor of the individual party seeking relief and only to the extent necessary to provide relief to the party's individual claim.",
            "Notwithstanding anything to the contrary in this Arbitration Clause, if a court decides, in a final nonappealable decision, that the limitations of this Class Action Waiver section are invalid or unenforceable as to a particular claim or request for relief (such as a request for public injunctive relief), you and MEDVi agree that particular claim or request for relief (and only that particular claim or request for relief) will be severed from the arbitration and will be pursued in the courts specified in the 'Governing Law; Forum' section.",
            "Batch Process. 25 or more arbitration demands of a substantially similar nature filed within a 180-day period shall constitute a "Mass Filing." Arbitration demands are of a "substantially similar nature" if they relate to the same event or factual scenario, raise the same or similar legal issues, and seek similar relief. The parties agree as follows with respect to Mass Filings: to administer the Mass Filing in batches of 25 demands per batch (or less, if fewer than 25 remain) ("Batches"), with only one Batch filed, processed, and adjudicated at a time; to designate one arbitrator for each Batch; to accept applicable fees, including any related fee reduction determined by NAM in its discretion; that no other demands for arbitration that are part of the Mass Filing may be filed, processed, or adjudicated until the prior Batch is filed, processed, and adjudicated, unless the Administrative Arbitrator determines that applicable law requires otherwise; that fees associated with a demand for arbitration included in a Mass Filing, including fees owed by MEDVi and the claimants, will only be due after your demand for arbitration is included in a Batch that is properly designated for filing, processing, and adjudication; and that the Batch process will continue until each demand (including your demand) is adjudicated or otherwise resolved.",
        ...
        {
          heading: "XXII. Copyright Infringement",
          level: 2,
          body: [
            "MEDVi reserves the right to remove any content or any other material or information available on or through our Platform, at any time, for any reason. MEDVi complies with the provisions of the Digital Millennium Copyright Act ("DMCA") applicable to Internet service providers (17 U.S.C. § 512, as amended), and responds to clear notices of alleged copyright infringement. This Section XXII describes the procedure that should be followed to file a notification of alleged copyright infringement with MEDVi.",
            "If you have objections to copyrighted content or material made available on or through our Platform, you may submit a notification to our Designated Agent at the following address: help@medvi.org.",
          ],
        },
        {
          heading: "Notification of Claimed Copyright Infringement",
          level: 3,
          body: [
            "Any notification to MEDVi regarding copyright infringement must include the following information:",
            ...
            "Information sufficient for MEDVi to contact you, such as your address, telephone number, and/or email address.",
        ...
        {
          heading: "XXIV. Contact Information",
          level: 2,
          body: [
            "If you have any questions or concerns, please contact help@medvi.org.",
          ],
        },
      ]}
    />
